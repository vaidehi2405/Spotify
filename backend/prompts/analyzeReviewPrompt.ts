...
Rules:
- Sentiment: classify the user's tone toward Spotify/the reviewed experience independently from relevance. Use "positive" for clear praise or satisfaction (e.g. enjoying the app, favorite app, best music app, Discover Weekly reads my mind, solid audio quality). Use "negative" for complaints, frustration, broken behavior, ads/payment anger, or dissatisfaction. Use "neutral" for mixed, informational, unclear, or balanced reviews. If pain_point is "not_relevant", still set sentiment based on the raw review tone; do NOT default unrelated positive reviews to negative.
